<template>
  <div class="blog">
     ...
     <h2 class="h1-responsive font-weight-bold text-center my-5">Blog</h2>
	  <hr class="my-5" /><mdb-row>
      <mdb-col lg="5" xl="4">
        <mdb-view hover class="rounded z-depth-1-half mb-lg-0 mb-4">
          <img class="img-fluid" src="https://mymodernmet.com/wp/wp-content/uploads/2018/01/dronestagram-best-aerial-photos-2017-6.jpg" alt="Sample image" />
          <a>
            <mdb-mask overlay="white-slight" waves/>
          </a>
        </mdb-view>
      </mdb-col>
      <mdb-col lg="7" xl="8" class="corpo">
       ...
       <mdb-btn tag="a" href="#/BlogPage" color="primary"  size="md">Ver Mais</mdb-btn> 
      </mdb-col>
    </mdb-row>
    <hr class="my-5" />
    <mdb-row>
      <mdb-col lg="5" xl="4">
        <mdb-view hover class="rounded z-depth-1-half mb-lg-0 mb-4">
          <img class="img-fluid" src="https://i.ytimg.com/vi/82gc8UYizN8/maxresdefault.jpg" alt="Sample image" />
          <a>
            <mdb-mask overlay="white-slight" waves/>
          </a>
        </mdb-view>
    ...
    <mdb-row>
      <mdb-col lg="5" xl="4" >
        <mdb-view hover class="rounded z-depth-1-half mb-lg-0 mb-4">
          <img class="img-fluid" src="https://scontent.fbfh3-2.fna.fbcdn.net/v/t1.0-9/59581201_2416492631728552_175894913819344896_n.jpg?_nc_cat=108&_nc_oc=AQntJyHB2Yy093HwOJibSYvtO9pvDSDtkJLkcKzCm4tzh83M_7cVpWiHktKFY_adsAMi7OUI7wzCl73semI7THnP&_nc_ht=scontent.fbfh3-2.fna&oh=e29f459cf92811660d35ef104b38e19b&oe=5D7122BA" alt="Sample image" />
          <a>
            <mdb-mask overlay="white-slight" waves/>
          </a>
        </mdb-view>
  ...
  <mdb-container style="margin-top: 75px;">
  <mdb-row>
   <mdb-btn-toolbar>
